...
The first is the Personal Information Management application, which is highly simplified, but illustrates the concepts and is easy to understand.
The second is the ....

\subsection{The Personal Information Management Application}
\label{sec-pim}
...
write an equivalent non-recursive statement\cite{peter:ml-2015-05-20}.
...
The following example illustrates an essentially recursive constraint.
